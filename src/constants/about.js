  ...
  [LANGUAGES.AR]: {
    ...
    cards: [
...

      {
        ...
        body: "ثم استكشفت تصميم واجهات المستخدم، ودرست مبادئ التخطيط، ونظرية الألوان، والتسلسل الهرمي البصري. وباستخدام أداتي Figma وAdobe XD عملت على مشاريع تدريبية وحقيقية، مما ساعدني على تحويل الأفكار الأولية إلى واجهات واضحة، متناسقة، وجذابة بصريًا للمستخدمين.",
      },
